...
The established Map Materials receiver at PR #14 remains pinned to the historical Building source head `4faa769b406bf3ad0ba9489a77141c27f122ce51`. Numeric vertex/placement equality is not successor provenance. This lane closes only that receiving identity edge.

## Bounded repair

This lane stacks on exact Map PR #14 head `0e2d571af4fd5772e9d48da013dc245914654660` and reuses its existing receiving builder and Godot observer unchanged.

New Technical Art data only:
...
No Building material values are authored here. No current-world PR #24 state is changed here. No Runtime policy is changed here.
...
- Building Hard Surface owns the successor source/topology semantics.
- Building Materials owns material values and the separate current-world infill repair.
- Technical Art owns this exact cross-repo receiving/provenance handoff.
