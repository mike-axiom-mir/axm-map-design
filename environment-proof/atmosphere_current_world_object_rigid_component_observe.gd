...
const EXACT_OBJECT_TA_HEAD := "965fb2f24dbd0b0cbb748d9f8b8712d62966315f"
...
func write_receipt()->void:
    ...
    receipt["technical_art_object_rigid_component_truth_boundary"]="Exact neutral receiver articulation boundary only. Source-owned rigid groups are exposed as transformable nodes while current Map materials/normals/UV/roughness remain receiver-owned. Animation/VFX application and Runtime/Art/QA/CANON acceptance remain held."
    super.write_receipt()
