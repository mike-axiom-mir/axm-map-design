...
const SELECTED_ROUGHNESS_RULE := "SPATIAL_MATERIAL_FIELD_MAY_ENTER_CURRENT_WORLD_REVIEW_ONLY_AFTER_EXACT_SURFACE_AND_UV_IDENTITY__APPEARANCE_AND_RUNTIME_ACCEPTANCE_REMAIN_SEPARATE"
...
func _load_selected_roughness_texture()->Dictionary:
    ...
    if summary.is_empty():
        return {}
    if String(summary.get("sha256",""))!=SELECTED_ROUGHNESS_SCALAR_SHA256:
...
func write_receipt()->void:
    ...
    receipt["environment_object_selected_roughness_current_world_rule"]=SELECTED_ROUGHNESS_RULE
