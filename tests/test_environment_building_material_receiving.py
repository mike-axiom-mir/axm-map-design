...
class EnvironmentBuildingMaterialReceivingTests(unittest.TestCase):
    ...
    def test_exact_building_material_family_changes_only_surface_response(self):
        ...
        self.assertEqual(report["building_material_head"], "b08f683f1c3f75c474fb347e1d1990c1c4426a33")
        ...
        self.assertEqual(report["material_profile_sha256"], "e8dd0c33b9b2aea108194af57a8fe8de39c7e67bb86109af6dbf3895f22c010b")
        self.assertLessEqual(report["placement_translation_max_error_m"], mod.EPS)
        self.assertLessEqual(report["component_alignment"]["component_alignment_max_error_m"], mod.EPS)
